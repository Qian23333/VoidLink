...
@objc protocol ToolboxSpecialEntryDelegate: NSObjectProtocol {
    ...
    @objc optional func disconnectAndExitStream()
}
...
@objc public class ToolboxViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @objc public var specialEntries : NSMutableArray = ["widgetSwitchTool", "widgetLayoutTool", "bringUpSoftKeyboard", "enterPip", "disconnectAndExitStream"]
    private let specialEntryAliasDic : [String:String] = [
        ...
        "disconnectAndExitStream":SwiftLocalizationHelper.localizedString(forKey: "[ Disconnect and Exit Stream ]")
    ]
    ...
    private func handleSpecialEntries(index:Int){
        ...
        case "disconnectAndExitStream":
            specialEntryDelegate?.disconnectAndExitStream?()
        default: break
        }
    }
